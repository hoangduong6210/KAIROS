...
`snapshots/kairos-conference-final/` is a PDF-only provenance record. Its
...
distribution of the final PDF as provided; supporting records are retained
privately where applicable. This statement closes only the author-consent gate.
The former venue-specific source/template bundle was removed from public
surfaces.
...
distribution of the final PDF as provided. This closes the author-consent gate
for that PDF; it does not grant rights in third-party material or establish that
an employer, sponsor, venue, or publisher has no separate rights.
